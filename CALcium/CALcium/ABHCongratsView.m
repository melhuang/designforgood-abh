...
- (void)createSubviews {
    ...
    NSString *rdaString = @"You reached your calcium RDA: ";
    
    NSString *floatString = [[NSNumber numberWithFloat:self.RDA] stringValue];
    rdaString = [rdaString stringByAppendingString:floatString];
    rdaString = [rdaString stringByAppendingString:@" mg."];
    _reached.text = rdaString;
    
    _reached.numberOfLines = 0;
    _reached.lineBreakMode = NSLineBreakByWordWrapping;
    _reached.font = [UIFont fontWithName:@"Helvetica" size:25];
    ...
    _message.font = [UIFont fontWithName:@"Helvetica" size:20];
